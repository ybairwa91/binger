...
//refs to select Dom element and we styled to focus
...
// HOW NOT to select dom in react
// function Search({ query, setQuery }) {
//   //lets manually select element
//   useEffect(function () {
//     const el = document.querySelector('.search')
//     console.log(el);
//     //dom method which means focus is on search input ,when u type it will be on search input field already.
//     el.focus();
//   }, [query])
//   //but this is not ideal and react never want u to manually change dom element using js DOM
//   //to solve all these issues we need refs
...
//USING useRef
function Search({ query, setQuery }) {
  //ye to kardiya declare
  const inputEl = useRef(null);
  //now ref attribute leke jisko bhi select krnaa hai useref ke through usme pass krde
  //here we select on input element so useRef me ab wo select ho gyaa h dost
  //so inputEl means input element of search bar

  //
  useEffect(function () {
    //useRef has current method to access value
